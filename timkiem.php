					...
					<div class="row">
						<div class="col-md-12">
							...
							<?php
							   ...
							   $result = mysqli_query($conn, "select count(SP_ID) as total from san_pham where SP_Ten like '%$tentimkiem%' " );
							   ...
							   $result = mysqli_query($conn, "SELECT * FROM san_pham where SP_TEN like '%$tentimkiem%'  LIMIT $start, $limit " );
