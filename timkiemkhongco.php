...
?>
								...
								<div class="product">
								<div class="image"><a href="product.php?spid=<?php echo $row["SP_ID"]?>"><img src="assets/img/prosuct_img<?php echo $row["SP_HINHANH"]?>" style="width:300px;height:300px"/></a></div>
								<div class="caption">
