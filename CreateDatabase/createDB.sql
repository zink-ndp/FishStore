-- Generation time: Mon, 24 Apr 2023 15:09:48 +0700
-- Host: localhost
-- DB name: shop_db
...
CREATE TABLE `chitiet_nhap` (
  ...
  `SP_SOLUONG` int(11) NOT NULL,
  PRIMARY KEY (`SP_ID`,`NH_ID`,`NH_NGAYNHAP`),
  KEY `FK_DO_NV` (`NV_ID`),
...
CREATE TABLE `danh_gia` (
  ...
  CONSTRAINT `FK_DANH_GIA` FOREIGN KEY (`TK_ID`) REFERENCES `tai_khoan` (`TK_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `khach_hang` (
  ...
  CONSTRAINT `FK_KH_CO_TK` FOREIGN KEY (`TK_ID`) REFERENCES `tai_khoan` (`TK_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `nhan_vien` (
  ...
  PRIMARY KEY (`NV_ID`),
  KEY `FK_TK_NV` (`TK_ID`),
  CONSTRAINT `FK_TK_NV` FOREIGN KEY (`TK_ID`) REFERENCES `tai_khoan` (`TK_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
