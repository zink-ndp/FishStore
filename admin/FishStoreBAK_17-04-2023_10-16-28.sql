-- Generation time: Mon, 17 Apr 2023 10:16:28 +0200
-- Host: localhost
-- DB name: shop_db
...
CREATE TABLE `chitiet_gh` (
  ...
  KEY `FK_RELATIONSHIP_18` (`KH_ID`),
  KEY `FK_RELATIONSHIP_19` (`SP_ID`),
  CONSTRAINT `FK_RELATIONSHIP_18` FOREIGN KEY (`KH_ID`) REFERENCES `khach_hang` (`KH_ID`),
  CONSTRAINT `FK_RELATIONSHIP_19` FOREIGN KEY (`SP_ID`) REFERENCES `san_pham` (`SP_ID`)
...
CREATE TABLE `chitiet_hd` (
  ...
  `SP_SOLUONG` int(11) NOT NULL,
  KEY `FK_RELATIONSHIP_20` (`SP_ID`),
  KEY `FK_RELATIONSHIP_21` (`HD_ID`),
  CONSTRAINT `FK_RELATIONSHIP_20` FOREIGN KEY (`SP_ID`) REFERENCES `san_pham` (`SP_ID`),
  CONSTRAINT `FK_RELATIONSHIP_21` FOREIGN KEY (`HD_ID`) REFERENCES `hoa_don` (`HD_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `chitiet_nhap` (
  ...
  KEY `FK_DO_NV` (`NV_ID`),
  KEY `FK_RELATIONSHIP_24` (`NH_ID`),
  CONSTRAINT `FK_DO_NV` FOREIGN KEY (`NV_ID`) REFERENCES `nhan_vien` (`NV_ID`),
  CONSTRAINT `FK_RELATIONSHIP_24` FOREIGN KEY (`NH_ID`) REFERENCES `nguon_hang` (`NH_ID`),
  CONSTRAINT `FK_RELATIONSHIP_25` FOREIGN KEY (`SP_ID`) REFERENCES `san_pham` (`SP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `chitiet_nhap` VALUES ('1','2','1','2023-04-12','20'),
('2','2','1','2023-03-19','50'),
('3','2','1','2023-03-19','15'),
('4','3','1','2023-03-16','4'),
('5','1','1','2023-03-19','11'),
...
CREATE TABLE `danh_gia` (
  ...
  KEY `FK_DANH_GIA` (`TK_ID`),
  KEY `FK_NV_PHAN_HOI` (`NV_ID`),
  CONSTRAINT `FK_CO_DANH_GIA` FOREIGN KEY (`SP_ID`) REFERENCES `san_pham` (`SP_ID`),
  CONSTRAINT `FK_DANH_GIA` FOREIGN KEY (`TK_ID`) REFERENCES `tai_khoan` (`TK_ID`),
  CONSTRAINT `FK_NV_PHAN_HOI` FOREIGN KEY (`NV_ID`) REFERENCES `nhan_vien` (`NV_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `don_van_chuyen` (
  ...
  PRIMARY KEY (`DVC_ID`),
  KEY `FK_DO` (`NVC_ID`),
  CONSTRAINT `FK_DO` FOREIGN KEY (`NVC_ID`) REFERENCES `nha_van_chuyen` (`NVC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `hoa_don` (
  ...
  CONSTRAINT `FK_AP_DUNG` FOREIGN KEY (`KM_ID`) REFERENCES `khuyen_mai` (`KM_ID`),
  CONSTRAINT `FK_CO_HOADON` FOREIGN KEY (`KH_ID`) REFERENCES `khach_hang` (`KH_ID`),
  CONSTRAINT `FK_CO_PHUONGTHUC` FOREIGN KEY (`PTTT_ID`) REFERENCES `pt_thanhtoan` (`PTTT_ID`),
  CONSTRAINT `FK_CO_TRANGTHAI` FOREIGN KEY (`TT_ID`) REFERENCES `trangthai_hd` (`TT_ID`),
  CONSTRAINT `FK_THUOC` FOREIGN KEY (`DVC_ID`) REFERENCES `don_van_chuyen` (`DVC_ID`),
  CONSTRAINT `FK_XACNHAN` FOREIGN KEY (`NV_ID`) REFERENCES `nhan_vien` (`NV_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('13','1','0','1',NULL,'2','5','445000','2022-01-20','álsssds'),
('14','1','3','1',NULL,'3','7','80000','2022-03-05','Lí do huỷ đơn'),
('15','1','2','1',NULL,'1','6','260000','2022-03-08',NULL),
...
CREATE TABLE `khach_hang` (
  ...
  PRIMARY KEY (`KH_ID`),
  KEY `FK_KH_CO_TK` (`TK_ID`),
  CONSTRAINT `FK_KH_CO_TK` FOREIGN KEY (`TK_ID`) REFERENCES `tai_khoan` (`TK_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `khach_hang` VALUES ('1','8','Nguyễn Văn Khách','0972666533','toilakhach@gmail.com','2001-04-17','A123, Đường A, huyện AA, tỉnh AAA','m','2022-03-16'),
...
CREATE TABLE `nhan_vien` (
  ...
  PRIMARY KEY (`NV_ID`),
  KEY `FK_TK_NV` (`TK_ID`),
  CONSTRAINT `FK_TK_NV` FOREIGN KEY (`TK_ID`) REFERENCES `tai_khoan` (`TK_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `nhan_vien` VALUES ('1','1','Nguyễn Đỗ Phúc Vinh','0377899959','admin@gmail.com','2002-11-01','m','2020-11-14'),
...
CREATE TABLE `san_pham` (
  ...
  CONSTRAINT `FK_THUOC_LOAI` FOREIGN KEY (`LSP_ID`) REFERENCES `loai_sp` (`LSP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tai_khoan` VALUES ('1','ad','ad','avatar.jpg','admin'),
...
CREATE TABLE `tin_tuc` (
  ...
  CONSTRAINT `FK_DO_NV_POST` FOREIGN KEY (`NV_ID`) REFERENCES `nhan_vien` (`NV_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('3','1','Hướng dẫn trang trí hồ cá đẹp','../index.php','news3.png','Tìm hiểu làm sao để hồ cá của bạn thật đẹp!','1'); 
