...
class Shuttle_Dumper_Native extends Shuttle_Dumper {
	public function dump($export_file_location, $table_prefix='') {
		...
		$this->dump_file->write("SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0;$eol");
		...
		$this->dump_file->write("SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS;$eol");
