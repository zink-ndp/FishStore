				...
				<div class="product">
					...
					<div class="col-md-6">
						<div class="caption">
							...
							<div class="info">
								<ul>
									<li>Loại sản phẩm: <a href="/category.php?maloaisp=<?php echo $row["LSP_ID"] ?>"><?php echo $row["TenLsp"] ?></a>
										<h3>
									</li>
							...
							<div class="well">
								<form name="form3" id="addcart" method="POST" action="">
									<input type="submit" name="submit" id="addcart" class="btn btn-2" value="Thêm vào giỏ hàng" />
