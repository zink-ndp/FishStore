    ...
    <div class="container">
        ...
        ?>
            <div class="row">
                <form name="form5" id="ff5" method="POST" action="removecart.php">
                    <div class="product well">
                        ...
                        <div class="col-md-9">
                            <div class="caption">
                                <div class="name">
                                    <h3><a href="product.php?id=<?php echo $row["SP_ID"] ?>"><?php echo $row["SP_Ten"] ?></a></h3>
                                </div>
                                <div class="info">
                                    <ul>
                                        <li>Tên loại sản phẩm: <?php echo $row["tenloaisp"] ?></li>
                                    </ul>
                                </div>
                                ...
                                <input class="form-inline quantity" style="margin-right: 80px;width:50px" min="1" max="99" type="number" name="qty[<?php echo $row["SP_ID"] ?>]" value="<?php echo $_SESSION['cart'][$row["SP_ID"]] ?>">
                                <div>
                                ...
                                <input type="hidden" name="idsprm" value="<?php echo $row["SP_ID"] ?>/>

                                <label style="color:red">Thành tiền: <?php echo  $_SESSION['cart'][$row["SP_ID"]] * $row["SP_Gia"] ?> </label>
                            </div>
                        </div>
                ...
                <?php
                $total += $_SESSION['cart'][$row["SP_ID"]] * $row["SP_Gia"] ?>
                <?php
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-8 ">
                    <center><a href="index.php" class="btn btn-1" style="margin-left:-76px">Chọn sản phẩm khác</a></center>
                </div>
                <div class="row">
