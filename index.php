...
<?php 
    ...
    ?>
    					<div class="row">
				<div class="col-lg-12">
					<div class="heading"><h2>Cá đang khuyến mãi</h2></div>
...
?>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="product.php?id=<?php echo $row["SP_ID"]?>"><img src="assets/img/product_img/ echo $row["SP_HINHANH"]?>" style="width:300px;height:300px" /></a></div>
								<div class="caption">
